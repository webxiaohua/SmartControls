...
namespace SmartWinControls.SmartControls.ScrollBar
{
    public class SmartScrollBarThemeBase : IDisposable
    {
        ...
        public SmartButtonThemeBase SideButtonTheme { get; set; }
        public SmartButtonThemeBase MdlButtonTheme { get; set; }
        ...
        private SmartButtonThemeBase GetMdlButtonTheme()
        {
            SmartButtonThemeBase theme = new SmartButtonThemeBase();
        ...
        public SmartScrollBarThemeBase()
        {
            SetDefaultValue();
        }
