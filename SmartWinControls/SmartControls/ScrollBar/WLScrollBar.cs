...
using SmartWinControls.SmartControls.TrackBar;
...
namespace SmartWinControls.SmartControls.ScrollBar
{
    ...
    public class WLScrollBar : WLContainerBase
    {
        ...
        SmartScrollBarThemeBase _xtheme;
        int _maximum = 100;
        int _minimum = 0;
        int _value = 0;
        int _smallChange = 1;
        ...
        // readonly        
        public SmartScrollBarThemeBase XTheme
        {
            get
            {
                if (_xtheme == null)
                {
                    _xtheme = new SmartScrollBarThemeBase();
        ...
        public void SetNewTheme(SmartScrollBarThemeBase xtheme)
        {
            if (xtheme == null)
