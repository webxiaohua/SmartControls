...
{
    public class SmartRadioButton: System.Windows.Forms.RadioButton, ISmartControl
    {
        #region 构造函数及初始化
        ...
        {
            get { return SmartControlType.RadioButton; }
        }
        ...
        private SmartRadioButtonThemeBase _xtheme;
        private SmartButtonState state;

        private SmartRadioButtonThemeBase XTheme
        {
            get
            {
                if (_xtheme == null)
                    _xtheme = new SmartRadioButtonThemeBase();
                return _xtheme;
            }
        }
